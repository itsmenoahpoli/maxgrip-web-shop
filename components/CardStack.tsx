...
export function CardStack({ items, offset, scaleFactor }: Props) {
  ...
  return (
    <div className="relative h-60 w-60 md:h-60 md:w-96">
      {cards.map((card, index) => (
        ...
        >
          <div className="text-neutral-700 dark:text-neutral-200">{card.content}</div>
          <div>
